...
class Environment:
	...
	def action(self, action):
		...
		if   self._action == 0 and action == 0:
			pass
		elif self._action == 0 and action == 1:
			pass
		elif self._action == 1 and action == 0:
			pass
		elif self._action == 1 and action == 1:
			pass
		else:
	...
	def reward(self, price, action, prev_price, prev_action):
		...
		r_p = prev_action * ( price - prev_price ) / prev_price
		r_n = self.fees * math.sqrt( ( action - prev_action ) ** 2 )
		return float(100 * ( r_p - r_n ))
